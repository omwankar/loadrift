...
import { APP_NAME, APP_TAGLINE, GITHUB_PROFILE_URL } from './brand';
  ...
  return (
    <div className="app">
      <header className="app-bar" ref={barRef}>
            ...
            <span className="app-mark" aria-hidden="true">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <path
                  ...
                  strokeLinecap="round"
                />
                <circle cx="11" cy="8" r="2" fill="var(--accent)" />
              </svg>
            </span>
        ...
        */}
          <a
            className="btn btn-icon app-profile-link"
            href={GITHUB_PROFILE_URL}
            target="_blank"
            rel="noreferrer noopener"
            aria-label="omwankar on GitHub"
            title="omwankar on GitHub"
            data-chrome=""
          >
            <svg
              width="16"
